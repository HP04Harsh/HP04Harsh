...
<table width="100%">
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p>Architected an end-to-end continuous delivery lifecycle for AI models using <b>Azure Machine Learning</b> and <b>ArgoCD</b>. Automated model versioning and deployment with real-time drift monitoring.</p>
      <code>MLOps</code> <code>Azure ML</code> <code>ArgoCD</code> <code>Grafana</code>
    </td>
  </tr>
</table>
